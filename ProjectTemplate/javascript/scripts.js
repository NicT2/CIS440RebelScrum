...
$("#dropMenu").prepend(
	...
	// "<p>test lololol</p>"
	 ...
	 "<form class=\"px-4 py-3\"> <label style=\"text-align: center;\"><strong>Give us your feedback!</strong></label> <div class=\"form-group\"> <button class=\"btn btn-light container\" onclick=\"happyForm(\'dropMenu\')\" style=\"margin: 10px; margin-left:0; text-align: left\"><img src=\"./images/heart_eyes.png\">&nbsp;&nbsp;&nbsp;Love</button> </div> <div class=\"form-group\">  <button class=\"btn btn-light container\" onclick=\"madForm(\'dropMenu\')\" style=\"margin: 10px; margin-left:0; text-align: left\"><img src=\"./images/vomit.png\">&nbsp;&nbsp;&nbsp;HATE</button> </div> <div class=\"form-group\"> <button class=\"btn btn-light container\" onclick=\"suggestForm(\'dropMenu\')\" style=\"margin: 10px; margin-left:0; text-align: left\"><img src=\"./images/comment.png\">&nbsp;&nbsp;&nbsp;Leave a comment</button> </div> </form>"
